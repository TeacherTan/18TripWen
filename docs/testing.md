...
### 6 个 mock 打卡点（spot_token 固定，可直接拼接 URL 测试）

| # | 名称 | asset_key | spot_token |
|---|------|-----------|------------|
| 1 | 签到台 | spot_01 | `11111111-0000-0000-0000-000000000001` |
| 2 | 主舞台 | spot_02 | `11111111-0000-0000-0000-000000000002` |
| 3 | 市集区 | spot_03 | `11111111-0000-0000-0000-000000000003` |
| 4 | 拍照打卡墙 | spot_04 | `11111111-0000-0000-0000-000000000004` |
| 5 | 待定点位5 | spot_05 | `11111111-0000-0000-0000-000000000005` |
| 6 | 待定点位6 | spot_06 | `11111111-0000-0000-0000-000000000006` |
...
| 打卡（spot_01） | `http://localhost:5173/?spot=11111111-0000-0000-0000-000000000001` |
...
| CHK-05 | 打满 6 个点 | Profile 进度显示「已集齐 6/6 张图纸」 |
